  ...
  <div>
    ...
    <div v-if="!isMulti" aria-label="单页">
      <div style="height: 400px; padding-bottom: 10px">
        ...
        <template #right>
          ...
          <XGanttColumn label="bbb" date-format :merge="merge5">
            <template #default>
    ...
    <div v-else aria-label="多页">
      <div style="padding-bottom: 10px">
        ...
        <button @click="() => (showWeekend2 = !showWeekend2)">
          显示weekend
        </button>
      ...
      <div style="padding-bottom: 10px">
        ...
        <button @click="() => (showWeekend3 = !showWeekend3)">
          显示weekend
        </button>
...
export default defineComponent({
  ...
  methods: {
    ...
    rowChecked(state: boolean, data: any, list: any[]) {
      console.log('check row:', state, data, list);
    },

    // start 与 end 为旧的日期
    moveSlider(data: any[], old: { start: Date; end: Date }) {
      console.log('move slider:', data, old);
    },

    // old 为旧的进度
    moveProgress(data: any[], old: number) {
      console.log('move progress:', data, old);
    },

    noDateError(date: Date) {
    ...
    handleMove({ level }: { data: any; level: number }) {
      return level !== 1;
    },
